  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        },
        {
          ...
          imageAlt: "Sales Consultation",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/attractive-female-model-off-shoulder-dress-posing-near-vehicle_181624-5421.jpg",
          imageAlt: "Experience Driving",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/beautiful-shot-sunset-cote-d-azur-french-rivera-france_181624-45824.jpg",
          imageAlt: "Headlight Night",
        },
      ]}
    />
  </div>
      ...
      features={[
        {
          ...
          description: "Every vehicle undergoes a 200-point rigorous check.",
          icon: Shield,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Drive with confidence knowing you're protected.",
          icon: Award,
          mediaItems: [
            {
      ...
      products={[
        {
          ...
          price: "$35,000",
          variant: "Silver",
          imageSrc: "http://img.b2bpic.net/free-photo/silver-coupe-speeds-with-visible-plate-highway-editorial-motion_169016-71144.jpg",
        },
        {
          id: "2",
          ...
          price: "$18,500",
          variant: "Blue",
          imageSrc: "http://img.b2bpic.net/free-photo/futuristic-city-with-high-tech-mobility-social-welfare_23-2151065348.jpg",
        },
        {
          id: "3",
          name: "Crossover SUV",
        ...
        },
        {
          ...
          price: "$22,000",
          variant: "Black",
          imageSrc: "http://img.b2bpic.net/free-photo/futuristic-city-with-high-tech-mobility-social-welfare_23-2151065342.jpg",
        },
        {
          id: "5",
          name: "Premium SUV",
        ...
        },
        {
          ...
          price: "$32,000",
          variant: "White",
          imageSrc: "http://img.b2bpic.net/free-photo/man-unplugging-electric-charger-from-dock-charge-station_1268-17717.jpg",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          quote: "Singh Auto made my purchase seamless and stress-free.",
          name: "Sarah Johnson",
          role: "CEO",
          imageSrc: "http://img.b2bpic.net/free-photo/person-giving-order-customer-curbside-pickup_23-2149106362.jpg",
        },
        {
          id: "2",
          title: "Highly Recommend",
          quote: "The team was knowledgeable and helped me find the perfect car.",
          name: "Michael Chen",
          role: "CTO",
        ...
        },
        {
          id: "3",
          title: "Top Quality",
          quote: "Fantastic service and great vehicle selection.",
          name: "Emily Rodriguez",
          role: "Director",
          imageSrc: "http://img.b2bpic.net/free-photo/family-summer-forest-by-open-trunk_1157-35904.jpg",
        },
        {
          id: "4",
          title: "Very Happy",
          quote: "Excellent support after the sale. Truly appreciate it.",
          name: "David Kim",
          role: "Manager",
        ...
        },
        {
          ...
          quote: "My new SUV is exactly what I wanted. Thank you!",
          name: "Linda Smith",
          role: "Architect",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-female-bus-driver_23-2151589863.jpg",
        },
      ]}
